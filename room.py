...
from settings import Border, RoomType, TILE_SIZE
...
class Room:
    ...
    def import_floor(self, gameplay, floor_graphic):
        ...
        return Tile(gameplay.floor, (floor_x, floor_y + 20), floor)
    ...
    def random_chest_type(self):
        ...
        elif random_number in range(89, 100): return 'nigger'
                    ...
                    if col != '-1':
                        ...
                        if style == 'walls':
                            if int(col) in [1, 2, 9, 10]:
                                ...
                                Tile([gameplay.visible_sprites, gameplay.walls], (x, y), self.walls[int(col)])
                        if style == 'item':
    ...
    def add_top_tile(self, groups, pos, image):
        Tile(groups, pos, image)
        x_place, y_place = pos
        Tile(groups, (x_place, y_place + TILE_SIZE), self.shadow)
